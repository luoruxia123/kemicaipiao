...
class Login extends Component{
    ...
    componentDidMount(){
        const leftContent = <div style={{display:'flex',justifyContent:'center',alignItems:'center'}}
                                onClick={this.goBack}    
                                >
        ...
        return(
            <div className='login'>
                ...
                <div className='loginBottom'>
                    <Button style={{flex:1,height:'52px'}}>忘记密码?</Button>    
                    <Button style={{flex:1,height:'52px'}} onClick={this.pushView}>注册</Button>
                </div>
                <Switch>
